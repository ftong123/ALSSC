...
image = loadmat(r'data\images\PaviaU\PaviaU.mat')
imageGT = loadmat(r'data\images\PaviaU\PaviaU_gt.mat')
image_input = image["paviaU"]
labels = imageGT["paviaU_gt"]
...
for i in range(scale_num):
    seg_name = r'data\segmentation_maps\PaviaU\PaviaU_seg_' + str(2 * i + 3) + 'X' + str(2 * i + 3) + '.mat'
...
color_table = np.zeros((9, 3), dtype=np.uint8)  # define the color table
color_table[0] = [10, 0, 255]
color_table[1] = [255, 0, 0]
color_table[2] = [0, 255, 255]
color_table[3] = [0, 192, 0]
color_table[4] = [255, 0, 255]
color_table[5] = [165, 82, 41]
color_table[6] = [128, 0, 128]
color_table[7] = [192, 192, 192]
...
save_path = r'classification_map\PaviaU\ALSSC_PaviaU_Classification_Map.png'
