...
image_input = gdal.Open(r'data\images\Tree_Species\sg_quac_test2.tif').ReadAsArray()
labels = gdal.Open(r'data\images\Tree_Species\sg_quac_test2_gt.tif').ReadAsArray()
[dim, row, col] = image_input.shape
...
for i in range(scale_num):
    seg_name = r'data\segmentation_maps\Tree_Species\Tree_seg_' + str(2 * i + 3) + 'X' + str(2 * i + 3) + '.mat'
...
image_input = image_input.reshape((dim, row * col))
...
color_table = np.zeros((12, 3), dtype=np.uint8)
color_table[0] = [203, 24, 27]
color_table[1] = [132, 255, 40]
color_table[2] = [39, 0, 247]
color_table[3] = [151, 11, 82]
color_table[4] = [209, 0, 250]
color_table[5] = [139, 253, 253]
color_table[6] = [157, 86, 24]
color_table[7] = [60, 91, 112]
color_table[8] = [72, 1, 183]
color_table[9] = [251, 254, 49]
color_table[10] = [255, 100, 0]
color_table[11] = [192, 192, 192]
...
save_path = r'classification_map\Tree_Species\ALSSC_Tree_Classification_Map.png'
